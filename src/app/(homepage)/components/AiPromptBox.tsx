...
export default function AiPromptBox() {
  ...
  return (
    <div
      ref={containerRef}
      className="w-125 bg-secondary rounded-lg transition-colors overflow-hidden px-4.5 pb-3"
    >
      {attachmentFile ? (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-start gap-2">
                <div>
                  <div className="font-medium" title={attachmentFile.name}>
                    {formatFileName(attachmentFile.name)}
                  </div>
      ...
      <div className="flex justify-between">
              ...
              <PopoverContent className="w-69">
                <div className="grid gap-4">
                  <div className="space-y-2">
                    <h4 className="leading-none font-medium">Reasoning</h4>
                    <p className="text-sm text-muted-foreground">
                      When enabled, models will generate a step-by-step
                      breakdown of their logic before providing a final answer.
                      This may increase response times.
                    </p>
                    <Button
                      className="w-full"
                      onClick={() => {
        ...
        <div className="flex items-center gap-3 text-muted-foreground">
            ...
            >
              <TooltipTrigger asChild>
                <PopoverTrigger asChild>
                  <Button
                    variant="ghost"
                    className="px-2 h-8 text-xs font-medium hover:bg-background/50 rounded-full transition-all"
                  >
                    {loadingModels ? (
              ...
              <PopoverContent className="w-90 p-0 overflow-hidden">
                <ModelSelector
                  models={models}
          ...
          <Button
            ...
            className="disabled:hover:cursor-not-allowed rounded-full transition-all"
          >
